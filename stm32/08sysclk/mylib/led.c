...
void led_on(int nu)//通过形参nu选择点亮相应的LED灯
{
	switch(nu)
	{
		case 0 : PCOut(1) = 1; break;//把PC1管脚输出高电平
		case 1 : PCOut(2) = 1; break;//把PC2管脚输出高电平
		case 2 : PCOut(3) = 1; break;//把PC3管脚输出高电平
	}
}
...
void led_off(int nu)//通过形参nu选择灭掉相应的LED灯
{
	switch(nu)
	{
		case 0 : PCOut(1) = 0; break;//把PC1管脚输出低电平
		case 1 : PCOut(2) = 0; break;//把PC2管脚输出低电平
		case 2 : PCOut(3) = 0; break;//把PC3管脚输出低电平
	}
}
